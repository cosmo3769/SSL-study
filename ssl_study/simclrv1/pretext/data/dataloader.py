...
class GetDataloader():
    ...
    def simclr_augmenter(self, img):
        ...
        img = tfsim.augmenters.augmentation_utils.blur.random_blur(img, self.args.augmentation_config.image_height, self.args.augmentation_config.image_width, p=self.args.augmentation_config.probability)
